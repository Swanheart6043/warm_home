...
export const RegisterForm = () => {
  ...
  const formatRequestParams = (values: any): ScriptParams => {
    const valueJson = [
      { type: '2', key: '功能选项', value: matchOperationType(ScriptTypeEnum.Register), options: buildOperationTypeForValueJson() },
      { type: '', key: '注册方式', value: '邮箱', options: [] },
    ...
    return {
      ...values,
      operType: ScriptTypeEnum.Register,
