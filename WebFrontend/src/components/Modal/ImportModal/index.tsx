...
interface ImportModalProps {
  ...
  importRequest: (file: any) => Promise<OptionalResultList<string>>
}

export default NiceModal.create(({ title, downloadFileName, importRequest }: ImportModalProps) => {
  ...
  const importData = async (file: RcFile) => {
    ...
    try {
      ...
      const result = await importRequest(formData)
      message.destroy()
